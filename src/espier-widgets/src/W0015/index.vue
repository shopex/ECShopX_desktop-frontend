            ...
            >
              <div class="goods-list-wrap" v-for="(sitem, sindex) in item.data "  :key="`goods-list-wrap__${sindex}`">
                <div class="goods-wrap__info">
                  <div class="goods-title" :style="{color: value.wgtTitleColor , fontSize:value.wgtTitleFontSize + (sindex == 0 ?(+2) : (+0))  +'px'}">
                    {{ sitem.goods_name }}
               </div>
               <goodsPrice
                  class = "goods-price"
                ...
                <div class="goods-image">
                  ...
                  >
                    <ImgWrap
                      :src="sitem.goods_pic"
                      :width="sindex == 10?122:sindex == 0 ? 290 : 90"
    ...
    data: [
      {
        text: 'tab1',
        data: [
          { goods_id: '', goods_pic: '', price: 123, goods_name: '产品标题文案0',subTitle:"副标题文案最多控制副标题文案最多控制副标题文案最多控制副标", tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 1231, goods_name: '产品标题文案1', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 4234, goods_name: '产品标题文案2', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 68.9, goods_name: '产品标题文案3', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 220, goods_name: '产品标题文案4', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 320, goods_name: '产品标题文案5', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 99.99, goods_name: '产品标题文案6', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 22.22, goods_name: '产品标题文案7', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 1230, goods_name: '产品标题文案8', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 320, goods_name: '产品标题文案9', tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
          { goods_id: '', goods_pic: '', price: 22.22, goods_name: '产品标题文案10', tagList: [], linkPage: 'goods', linkPageLabel: '商品' }
