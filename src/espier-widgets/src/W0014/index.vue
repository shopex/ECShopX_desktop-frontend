              ...
              <div class="goods-list-wrap" v-for="(sitem, sindex) in item.data":key="`goods-list-wrap__${sindex}`">
                ...
                <div class="goods-wrap__info">
                 ...
                 <!-- <goodsPrice
                  ...
                  ></goodsPrice> -->
                  <div class="goods-subtitle" :style="{color: sindex == 0?'#8C8C8C':'#009EFF'}">
                    {{ sitem.brief }}
                  </div>
                  <div v-if="sindex==0" class="word23" >
                    <linkPage :mode="mode" :to="`/items/${sitem.goods_id}`" ctitleColor ="#FFFFFF;" >点击查看</linkPage>
                  </div>
                </div>
              </div>
    ...
    data: [
      {
        text: 'tab1',
        data: [
          { goods_id: '', goods_pic: '', price: 123, goods_name: '产品标题文案0',brief:"副标题文案最多控制副标题文案最多控制副标题文案最多控制副标题文行内副标题文案最多控制2行内", tagList: [], linkPage: 'goods', linkPageLabel: '商品' },
