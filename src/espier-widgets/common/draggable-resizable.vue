...
export default {
  ...
  methods: {
    reviewDimensions: function () {
      ...
      //     this.height = 'auto'
      // } else {
      //     if ( this.resizableAxis === 'xy' ) {
      //         this.width = this.$el.children[this.$el.children.length - 1].clientWidth + 2
      //         this.height = this.$el.children[this.$el.children.length - 1].clientHeight + 2
      //     } else if ( this.resizableAxis === 'x' ) {
      //         this.width = this.$el.children[this.$el.children.length - 1].clientWidth + 2
      //         this.height = 'auto'
      //     } else if ( this.resizableAxis === 'y' ) {
      //         this.width = 'auto'
      //         this.height = this.$el.children[this.$el.children.length - 1].clientHeight + 2
      //     }
      // }
