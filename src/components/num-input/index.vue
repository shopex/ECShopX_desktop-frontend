...
>
  ...
  >
  <span
    class="sp-num-input__btn sp-num-input__btn-up"
    :class="{ 'is-disabled': value >= max }"

    @click="increase"
    @mousedown="startTick('increase')"
    @mouseup="stopTick()"
  >+</span>
  <span
    class="sp-num-input__btn sp-num-input__btn-down"
    :class="{ 'is-disabled': value <= min }"

    @click="decrease"
    @mousedown="startTick('decrease')"
    @mouseup="stopTick()"
  >-</span>
</div>
</template>
